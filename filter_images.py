...
if __name__ == "__main__":
	generate_labels_from_file('F:/Dataset/Diabetic retinopathy/train_002','G:/Diabetic Retinopathy/trainLabels.csv','F:/Dataset/Diabetic retinopathy/train002Labels_filter.csv')
